...
const AchievementsAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) { 
        await axios.put(`${API_URL}/api/achievements/update-achievement/${editId}`, payload);
      } else {
        await axios.post(`${API_URL}/api/achievements/create-achievement`, payload); 
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${API_URL}/api/achievements/delete-achievement/${id}`);
      fetchCerts();
    } catch (err) {
      console.log(err);
    }
